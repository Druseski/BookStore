...
namespace BookStore.Data.Migrations
{
    ...
    [Migration("20210414175054_initial-seed")]
            ...
            modelBuilder.Entity("BookStore.Entities.Author", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Country = "Country1",
                            DateBirth = new DateTime(2021, 4, 14, 19, 50, 54, 4, DateTimeKind.Local).AddTicks(4132),
                            Gender = "Female",
                            Language = "English",
                            Name = "Agatha Christie",
                            Popularity = false,
                            ShortDiscription = "Dame Agatha Mary Clarissa Christie, Lady Mallowan, DBE (née Miller; 15 September 1890 – 12 January 1976) was an English writer known for her 66 detective novels and 14 short story collections, particularly those revolving around fictional detectives Hercule Poirot and Miss Marple. She also wrote the world's longest-running play The Mousetrap and six romances under the pen name Mary Westmacott. In 1971, she was appointed a Dame Commander of the Order of the British Empire (DBE) for her contribution to literature"
                        },
                        new
                        {
                            ID = 2,
                            Country = "Country2",
                            DateBirth = new DateTime(2021, 4, 14, 19, 50, 54, 4, DateTimeKind.Local).AddTicks(4855),
                            Gender = "Male",
                            Language = "English",
                            Name = "Stephen King",
                            Popularity = true,
                            ShortDiscription = "Stephen Edwin King (born September 21, 1947) is an American author of horror, supernatural fiction, suspense, and fantasy novels. His books have sold more than 350 million copies, many of which have been adapted into feature films, miniseries, television series, and comic books. King has published 61 novels (including seven under the pen name Richard Bachman) and six non-fiction books. He has written approximately 200 short stories, most of which have been published in book collections."
                        },
                        new
                        {
                            ID = 3,
                            Country = "Country3",
                            DateBirth = new DateTime(2021, 4, 14, 19, 50, 54, 4, DateTimeKind.Local).AddTicks(4878),
                            Gender = "Male",
                            Language = "English",
                        ...
                        new
                        {
                            ID = 4,
                            Country = "Country4",
                            DateBirth = new DateTime(2021, 4, 14, 19, 50, 54, 4, DateTimeKind.Local).AddTicks(4881),
                            Gender = "Female",
                            Language = "English",
                            Name = "J. K. Rowling",
                            Popularity = false,
                            ShortDiscription = "Joanne Rowling CH, OBE, HonFRSE, FRCPE, FRSL, (born 31 July 1965), better known by her pen name J. K. Rowling, is a British author, film producer, television producer, screenwriter, and philanthropist. She is best known for writing the Harry Potter fantasy series,which has won multiple awards and sold more than 500 million copies, becoming the best-selling book series in history. The books are the basis of a popular film series, over which Rowling had overall approval on the scripts and was a producer on the final films. She also writes crime fiction under the name Robert Galbraith."
                        },
                        new
                        {
                            ID = 5,
                            Country = "Country5",
                            DateBirth = new DateTime(2021, 4, 14, 19, 50, 54, 4, DateTimeKind.Local).AddTicks(4885),
                            Gender = "Male",
                            Language = "English",
                            Name = "Leo Tolstoy",
                            Popularity = false,
                            ShortDiscription = "Count Lev Nikolayevich Tolstoy (9 September [O.S. 28 August] 1828 – 20 November [O.S. 7 November] 1910), usually referred to in English as Leo Tolstoy, was a Russian writer who is regarded as one of the greatest authors of all time. He received multiple nominations for the Nobel Prize in Literature every year from 1902 to 1906, and nominations for Nobel Peace Prize in 1901, 1902 and 1910, and the fact that he never won is a major Nobel prize controversy"
                        },
                        new
                        {
                            ID = 6,
                            Country = "Country6",
                            DateBirth = new DateTime(2021, 4, 14, 19, 50, 54, 4, DateTimeKind.Local).AddTicks(4887),
                            Gender = "Male",
                            Language = "English",
                            Name = "Paulo Coelho",
                            Popularity = false,
                            ShortDiscription = "Paulo Coelho de Souza (born 24 August 1947) is a Brazilian lyricist and novelist, best known for his novel The Alchemist. In 2014, he uploaded his personal papers online to create a virtual Paulo Coelho Foundation"
                        },
                        new
                        {
                            ID = 7,
                            Country = "Country7",
                            DateBirth = new DateTime(2021, 4, 14, 19, 50, 54, 4, DateTimeKind.Local).AddTicks(4891),
                            Gender = "Male",
                            Language = "English",
                            Name = "Jeffrey Archer",
                            Popularity = false,
                        ...
                        new
                        {
                            ID = 8,
                            Country = "Country8",
                            DateBirth = new DateTime(2021, 4, 14, 19, 50, 54, 4, DateTimeKind.Local).AddTicks(4893),
                            Gender = "Male",
                            Language = "English",
                            Name = "Ian Fleming",
                            Popularity = false,
                            ShortDiscription = "Ian Lancaster Fleming (28 May 1908 – 12 August 1964) was an English author, journalist and naval intelligence officer who is best known for his James Bond series of spy novels. Fleming came from a wealthy family connected to the merchant bank Robert Fleming & Co., and his father was the Member of Parliament for Henley from 1910 until his death on the Western Front in 1917. Educated at Eton, Sandhurst and, briefly, the universities of Munich and Geneva, Fleming moved through several jobs before he started writing."
                        },
                        new
                        {
                            ID = 9,
                            Country = "Country9",
                            DateBirth = new DateTime(2021, 4, 14, 19, 50, 54, 4, DateTimeKind.Local).AddTicks(4896),
                            Gender = "Male",
                            Language = "English",
                            Name = "Nicholas Sparks",
                            Popularity = false,
                            ShortDiscription = "Nicholas Charles Sparks (born December 31, 1965) is an American romance novelist and screenwriter. He has published twenty novels and two non-fiction books. Several of his novels have become international bestsellers, and eleven of his romantic-drama novels have been adapted to film all with multimillion-dollar box office grosses.His novels feature stories of tragic love with happy endings."
                        },
                        new
                        {
                            ID = 10,
                            Country = "Country10",
                            DateBirth = new DateTime(2021, 4, 14, 19, 50, 54, 4, DateTimeKind.Local).AddTicks(4900),
                            Gender = "Male",
                            Language = "English",
                            Name = "Dan Brown",
                            Popularity = false,
                            ShortDiscription = "Daniel Gerhard Brown (born June 22, 1964) is an American author best known for his thriller novels, including the Robert Langdon novels Angels & Demons (2000), The Da Vinci Code (2003), The Lost Symbol (2009), Inferno (2013) and Origin (2017). His novels are treasure hunts that usually take place over a period of 24 hours.[2] They feature recurring themes of cryptography, art, and conspiracy theories. His books have been translated into 57 languages and, as of 2012, have sold over 200 million copies. Three of them, Angels & Demons, The Da Vinci Code, and Inferno, have been adapted into films."
                        });
                });
            ...
            modelBuilder.Entity("BookStore.Entities.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Copies = 100,
                            Country = "UK",
                            DateAdded = new DateTime(2021, 4, 14, 19, 50, 54, 5, DateTimeKind.Local).AddTicks(3718),
                            Dimension = "12x12x20",
                        ...
                        new
                        {
                            ...
                            Copies = 50,
                            Country = "",
                            DateAdded = new DateTime(2021, 4, 14, 19, 50, 54, 5, DateTimeKind.Local).AddTicks(5431),
                            Dimension = "Not known",
                        ...
                        new
                        {
                            ...
                            Copies = 20,
                            Country = "USA",
                            DateAdded = new DateTime(2021, 4, 14, 19, 50, 54, 5, DateTimeKind.Local).AddTicks(5470),
                        ...
                        new
                        {
                            ...
                            Copies = 150,
                            Country = "USA",
                            DateAdded = new DateTime(2021, 4, 14, 19, 50, 54, 5, DateTimeKind.Local).AddTicks(5475),
                        ...
                        new
                        {
                            ...
                            Copies = 200,
                            Country = "USA",
                            DateAdded = new DateTime(2021, 4, 14, 19, 50, 54, 5, DateTimeKind.Local).AddTicks(5479),
                        ...
                        new
                        {
                            ...
                            Copies = 40,
                            Country = "USA",
                            DateAdded = new DateTime(2021, 4, 14, 19, 50, 54, 5, DateTimeKind.Local).AddTicks(5483),
                        ...
                        new
                        {
                            ...
                            Copies = 230,
                            Country = "USA",
                            DateAdded = new DateTime(2021, 4, 14, 19, 50, 54, 5, DateTimeKind.Local).AddTicks(5487),
                        ...
                        new
                        {
                            ...
                            Copies = 65,
                            Country = "UK",
                            DateAdded = new DateTime(2021, 4, 14, 19, 50, 54, 5, DateTimeKind.Local).AddTicks(5491),
                        ...
                        new
                        {
                            ...
                            Copies = 131,
                            Country = "UK",
                            DateAdded = new DateTime(2021, 4, 14, 19, 50, 54, 5, DateTimeKind.Local).AddTicks(5495),
                        ...
                        new
                        {
                            ...
                            Copies = 222,
                            Country = "UK",
                            DateAdded = new DateTime(2021, 4, 14, 19, 50, 54, 5, DateTimeKind.Local).AddTicks(5499),
                        ...
                        new
                        {
                            ...
                            Copies = 34,
                            Country = "USA",
                            DateAdded = new DateTime(2021, 4, 14, 19, 50, 54, 5, DateTimeKind.Local).AddTicks(5503),
                        ...
                        new
                        {
                            ...
                            Copies = 87,
                            Country = "USA",
                            DateAdded = new DateTime(2021, 4, 14, 19, 50, 54, 5, DateTimeKind.Local).AddTicks(5507),
                        ...
                        new
                        {
                            ...
                            Copies = 122,
                            Country = "UK",
                            DateAdded = new DateTime(2021, 4, 14, 19, 50, 54, 5, DateTimeKind.Local).AddTicks(5512),
                            Dimension = "4.32 x 6.04 x 0.57 inches",
                        ...
                        new
                        {
                            ...
                            Copies = 10,
                            Country = "UK",
                            DateAdded = new DateTime(2021, 4, 14, 19, 50, 54, 5, DateTimeKind.Local).AddTicks(5516),
                        ...
                        new
                        {
                            ...
                            Copies = 37,
                            Country = "UK",
                            DateAdded = new DateTime(2021, 4, 14, 19, 50, 54, 5, DateTimeKind.Local).AddTicks(5520),
                            Dimension = "4.10 x 6.70 x 1.00 inches",
                        ...
                        new
                        {
                            ...
                            Copies = 44,
                            Country = "UK",
                            DateAdded = new DateTime(2021, 4, 14, 19, 50, 54, 5, DateTimeKind.Local).AddTicks(5524),
                            Dimension = "4.10 x 6.70 x 1.00 inches",
                        ...
                        new
                        {
                            ...
                            Copies = 111,
                            Country = "USA",
                            DateAdded = new DateTime(2021, 4, 14, 19, 50, 54, 5, DateTimeKind.Local).AddTicks(5556),
                        ...
                        new
                        {
                            ...
                            Copies = 100,
                            Country = "USA",
                            DateAdded = new DateTime(2021, 4, 14, 19, 50, 54, 5, DateTimeKind.Local).AddTicks(5561),
                            Dimension = "4.28 x 7.54 x 1.33 inches",
                        ...
                        new
                        {
                            ...
                            Copies = 300,
                            Country = "UK",
                            DateAdded = new DateTime(2021, 4, 14, 19, 50, 54, 5, DateTimeKind.Local).AddTicks(5564),
                        ...
                        new
                        {
                            ...
                            Copies = 70,
                            Country = "UK",
                            DateAdded = new DateTime(2021, 4, 14, 19, 50, 54, 5, DateTimeKind.Local).AddTicks(5568),
                            Dimension = "5.82 x 8.52 x 0.94 inches",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "dd38b5ae-bce0-4574-a5a2-a56efefde7c9",
                            Name = "admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "31383703-9f68-408b-8b51-14a539b9c0c6",
                            Name = "editor",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "1d466f46-3777-4501-b685-03347f247ce0",
                            Name = "guest",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEMqFeWEzVTloYqje/1kuqnhZ+4PwiADyDOiqqALlmCp+PZrXioBxMdH6FX1wI+eVxw==",

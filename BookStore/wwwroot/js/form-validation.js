...
$(function () {
    ...
    $("form[name='bookcreate']").validate({
        ...
        messages: {
            ...
            Dimension: "Please enter dimensions of the book",
            Edition: {
            ...
            Discription: "Please enter description of the book",
            SoldItems: {
    ...
    $("form[name='createauthor']").validate({
        ...
        messages: {
            ...
            ShortDiscription: "Please enter short description about the author",
